    ...
    <!-- unicode starts here -->
      <section class="section-py-space premium-section">
        <div class="container">
          <div class="row g-md-4 g-3">
            <div class="col-md-6 wow bounceInLeft mt-0">
              <div class="premium-img"><img class="img-fluid" src="https://media.istockphoto.com/id/1465188429/photo/business-performance-monitoring-concept-businessman-using-smartphone-online-survey-filling.jpg?s=1024x1024&w=is&k=20&c=MMqtgXjSz4VRPEzmEW7UtruILvh22EruPNsUxz1yxmk=" alt="premium"></div>
            </div>
            <div class="col-md-6 wow bounceInRight mt-0">
              <div class="premium-wrapper">
                <h3 >Our Mission</h3>
