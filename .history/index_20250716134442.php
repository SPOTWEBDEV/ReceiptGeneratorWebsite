        ...
        <div class="row align-items-center justify-content-center">
          <div class="col-lg-6 col-md-7">
            <div class="home-text">
              ...
              <div class="docutment-button"> <a class="btn bg-secondary" href="./login/index.php">Get Started</a><a class="btn bg-light txt-dark" href="php/login/index.php<?php echo $sitename ?>/document/">Login</a></div>
            </div>
          </div>
