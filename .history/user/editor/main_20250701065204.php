...
<body class="p-2 w-full flex-col gap-2">
  <!-- SIDENAV -->
  <div
    class="bg-light p-2  shadow-sm rounded-sm w-full-mobile flex flex-col items-center gap-4 overflow-y-auto overflow-x-auto justify-center custom-scroll hide-scrollbar">
    <div
