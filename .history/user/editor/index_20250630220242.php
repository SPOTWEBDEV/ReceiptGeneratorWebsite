...
<head>
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .main-container { display: flex; gap: 2rem; flex-wrap: wrap; }
    .sidebar {
      width: 280px;
      background: #ffffff;
      padding: 1rem;
    ...
    .tab.active { border-color: #6c63ff; color: #6c63ff; }
    .filters {
      display: flex;
      flex-wrap: wrap;
      gap: 6px;
    ...
    .filter.active { background-color: #6c63ff; color: white; }
...
<body>
  ...
  <script>
    ...
    function renderFilters(categories) {
      ...
      const allBtn = $('<span class="filter active">All</span>');
  ...
  fetchTemplates(cat);
    ...
    $(document).ready(() => {
      ...
      $('#search-input').on('input', function () {
        ...
        const activeCategory = $('.filter.active').text();
        const category = activeCategory === 'All' ? '' : activeCategory;
        renderTemplates(allTemplates, keyword); // filter from memory
      });
    });
  </script>
