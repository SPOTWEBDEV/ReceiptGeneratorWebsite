<div class="page-header">
         <div class="header-wrapper row m-0">
                  <div class="header-logo-wrapper col-auto p-0">
                           <div class="logo-wrapper"><a href="index-2.html"> <img class="img-fluid for-light" src="<?php echo $domain ?>assets/images/logo/logo.png" alt=""><img class="img-fluid for-dark" src="../../assets/images/logo/logo_dark.png" alt=""></a></div>
                                    ...
                                    <div class="Typeahead Typeahead--twitterUsers">
                                             <div class="u-posRelative">
                                                      ...
                                                      <svg class="search-bg svg-color">
                                                               <use href="https://admin.pixelstrap.net/assets/svg/icon-sprite.svg#search"></use>
                                                      </svg>
                                             </div>
                                    </div>
                           </div>
                           ...
                           <ul class="nav-menus">
                                    ...
                                    <li class="onhover-dropdown">
                                             <div class="notification-box">
                                                      <svg>
                                                               <use href="https://admin.pixelstrap.net/assets/svg/icon-sprite.svg#Bell"></use>
                                                      </svg>
                                             </div>
                                    ...
                                    <li class="onhover-dropdown">
                                             <svg>
                                                      <use href="https://admin.pixelstrap.net/assets/svg/icon-sprite.svg#Bookmark"></use>
                                             </svg>
                                    ...
                                    <li class="onhover-dropdown">
                                             <div class="message position-relative">
                                                      <svg>
                                                               <use href="https://admin.pixelstrap.net/assets/svg/icon-sprite.svg#Message"></use>
                                    ...
                                    <li class="cart-nav onhover-dropdown">
                                             <div class="cart-box">
                                                      <svg>
                                                               <use href="https://admin.pixelstrap.net/assets/svg/icon-sprite.svg#Buy"></use>
                                                      </svg>
                                             </div>
                                    ...
                                    <li>
                                             <div class="mode">
                                                      <svg class="for-dark">
                                                               <use href="https://admin.pixelstrap.net/assets/svg/icon-sprite.svg#moon"></use>
                                                      </svg>
                                                      <svg class="for-light">
                                                               <use href="https://admin.pixelstrap.net/assets/svg/icon-sprite.svg#Sun"></use>
                                                      </svg>
                                             </div>
                                    </li>
                                             ...
                                             <div class="d-flex align-items-center profile-media"><img class="b-r-25" src="../../assets/images/dashboard/profile.png" alt="">
                                                      <div class="flex-grow-1 user"><span>Helen Walter</span>
                                                               <p class="mb-0 font-nunito">Admin
                                                                        <svg>
                                                                                 <use href="https://admin.pixelstrap.net/assets/svg/icon-sprite.svg#header-arrow-down"></use>
                                                                        </svg>
                                                               </p>
                                                      </div>
                                             </div>
