...
include('../server/clients/authoriazation/index.php');
...
<head>
         ...
         <meta charset="utf-8">
         <title><?php echo $sitename ?> | Transfer Page </title>
         ...
         <div class="group-data-[sidebar-size=sm]:min-h-sm group-data-[sidebar-size=sm]:relative">
                  ...
                  <div class="relative min-h-screen group-data-[sidebar-size=sm]:min-h-sm">
                           ...
                           <div class="group-data-[sidebar-size=lg]:ltr:md:ml-vertical-menu group-data-[sidebar-size=lg]:rtl:md:mr-vertical-menu group-data-[sidebar-size=md]:ltr:ml-vertical-menu-md group-data-[sidebar-size=md]:rtl:mr-vertical-menu-md group-data-[sidebar-size=sm]:ltr:ml-vertical-menu-sm group-data-[sidebar-size=sm]:rtl:mr-vertical-menu-sm pt-[calc(theme('spacing.header')_*_1)] pb-[calc(theme('spacing.header')_*_0.8)] px-4 group-data-[navbar=bordered]:pt-[calc(theme('spacing.header')_*_1.3)] group-data-[navbar=hidden]:pt-0 group-data-[layout=horizontal]:mx-auto group-data-[layout=horizontal]:max-w-screen-2xl group-data-[layout=horizontal]:px-0 group-data-[layout=horizontal]:group-data-[sidebar-size=lg]:ltr:md:ml-auto group-data-[layout=horizontal]:group-data-[sidebar-size=lg]:rtl:md:mr-auto group-data-[layout=horizontal]:md:pt-[calc(theme('spacing.header')_*_1.6)] group-data-[layout=horizontal]:px-3 group-data-[layout=horizontal]:group-data-[navbar=hidden]:pt-[calc(theme('spacing.header')_*_0.9)]">
                                    <div id='loaderBox' class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto" style="position: relative;">

                                             <div class="flex flex-col gap-2 py-4 md:flex-row md:items-center print:hidden">
                                                      <div class="grow">
                                                               <h5 class="text-16">International Transfer</h5>
                                                      </div>
                                             ...
                                             if (isset($_POST['transfer'])) {
                                                      ...
                                                      // Assuming you have these variables set earlier
                                                      $currency_symbol = 'USD';  // Example default currency
                                                      $currency_symbols = symbol($currency_symbol);

                                                      // Check account status and balance
                                                      if ($accountStatus == 'deactivated') {
                                                               echo "<script>
        window.onload = () => {
            Model('Transaction failed because your account has not been activated. Please contact Green Shield Finance support at support@greenshieldfinance.com for activation.', 'red');

            setTimeout(() => {
                window.location.href = './move-data.php';
            }, 3000);
        };
        </script>";
                                                      } elseif ($amount > $bal) {
                                                               echo "<script>
        window.onload = () => {
            Model('Insufficient balance. Please ensure your account has enough funds to complete this transfer.', 'red');
            ...
            <section style="width: 100%; padding: 10px 0; background: #131722; padding-bottom: 40px;">
                ...
                <div style="display: flex; align-items: center; margin-left: 20px;">
                    <p style="color: white; font-family: \'Trebuchet MS\', \'Lucida Sans Unicode\', \'Lucida Grande\', \'Lucida Sans\', Arial, sans-serif; margin-left: 8px; font-size: 30px;">
                      ' .  $sitename . ' 
                    </p>
                </div>
                <div style="width: 90%; padding: 10px; margin-left: 20px; background: white; box-sizing: border-box;">
                    ...
                    <p style="font-size: 15px; font-family: \'Trebuchet MS\', \'Lucida Sans Unicode\', \'Lucida Grande\', \'Lucida Sans\', Arial, sans-serif;">
                        The Green shield Finance Bank Team
                    </p>
                    <p style="font-size: 13px; font-family: \'Trebuchet MS\', \'Lucida Sans Unicode\', \'Lucida Grande\', \'Lucida Sans\', Arial, sans-serif; margin-top: 30px;">
                        © 2024 Green shield Finance Bank. All rights reserved.
                    </p>
                                                               ...
                                                               $stmt = $connection->prepare("INSERT INTO transfer (user, beneficiary_name, account_number,bank_name, iban, swift, amount, status, date,
        message, currency_symbol,otp) 
            VALUES (?, ?, ?, ?, ?, ?,?, ?, ?, 'Cancelled', ?, 'Your transaction is still cancelled', ?,?)");
                                                               $stmt->bind_param("ssssssssss", $id, $beneficiary_name, $account_number, $bank_name, $iban, $swift, $amount, $date, $currency_symbols, $otp);

                                                               // Execute the statement and send email
                                                               ...
                                                               $result = $stmt->execute();
                                                               $results = smtpmailer($email, $from, $from_name, $subject, $message);
            ...
            window.onload = () => {
                setTimeout(() => {
                    window.location.href = './verify.php?id=$last_id';
                }, 2000);
            };
            </script>";
                                                               } else {
                                                                        echo "<script>
            window.onload = () => {
                Model('Transfer failed. Please try again later.', 'red');
                                                               ...
                                                               <div class="mx-auto md:max-w-lg">
                                                                        <form method="POST">
                                                                                 <div class="grid grid-cols-1 gap-x-5 xl:grid-cols-2">
                                                                                          <div class="mb-4">
                                                                                                   <label for="firstNameInput" class="inline-block mb-2 text-base font-medium">Beneficiary Name <span class="text-red-500">*</span></label>
                                                                                                   <input name="beneficiary_name" type="text" id="firstNameInput" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200" placeholder="Enter Beneficiary name">
                                                                                                   <p id="firstNameError" class="mt-1 text-sm text-red-500"></p>
                                                                                          </div>
                                                                                          <div class="mb-4">
                                                                                                   <label for="lastNameInput" class="inline-block mb-2 text-base font-medium">Account Number <span class="text-red-500">*</span></label>
                                                                                                   <input name="account_number" type="text" id="lastNameInput" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200" placeholder="Enter Account number">
                                                                                                   <p id="lastNameError" class="mt-1 text-sm text-red-500"></p>
                                                                                          </div>
                                                                                 </div>

                                                                                 <div class="mb-4">
                                                                                          <label for="bankInput" class="inline-block mb-2 text-base font-medium"> Bank Name <span class="text-red-500">*</span></label>
                                                                                          <input name="bank_name" type="text" id="bankInput" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200" placeholder="Enter Bank Name">
                                                                                          <p id="emailError" class="mt-1 text-sm text-red-500"></p>
                                                                                 </div>

                                                                                 <div class="mb-4">
                                                                                          <label for="emailInput" class="inline-block mb-2 text-base font-medium"> Transfer Amount <span class="text-red-500">*</span></label>
                                                                                          <input name="amount" type="text" id="emailInput" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200" placeholder="Enter Transfer Amount">
                                                                                          <p id="emailError" class="mt-1 text-sm text-red-500"></p>
                                                                                 </div>
                                                                                 ...
                                                                                 <!--end grid-->
                                                                                 <div class="mb-4">
                                                                                          <label for="emailInput" class="inline-block mb-2 text-base font-medium"> IBAN <span class="text-red-500">*</span></label>
                                                                                          <input name="iban" type="text" id="emailInput" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200" placeholder="Enter IBAN">
                                                                                          <p id="emailError" class="mt-1 text-sm text-red-500"></p>
                                                                                 </div>
                                                                                 <div class="mb-4">
                                                                                          <label for="phoneNumberInput" class="inline-block mb-2 text-base font-medium">BIC or SWIFT Code <span class="text-red-500">*</span></label>
                                                                                          <input name="swift" type="text" id="phoneNumberInput" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200" placeholder="Enter BIC or SWIFT Code">
                                                                                 ...
                                                                                 <div class="flex justify-end gap-2 mt-5">
                                                                                          ...
                                                                                          <button name="transfer" type="submit" class="text-white btn bg-custom-500 border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100 dark:ring-custom-400/20">Submit</button>
                                                                                 </div>
                                                                        </form>
                                                               </div>
         ...
         <script src="//code.tidio.co/ktcsxnrphfuv4gog8g0tbdyjs0la5n0n.js" async></script>
